...
def initialize():
    ...
    stat = {"Q_value": q_value, "state": 0, "action": 0, "next_state": 0, "reward": 0,
            "time": 0, "total_reward": 0, "total_time": 0, "rho": rho, "flag": 0, "explore": 0.5}
...
def update(stat, iteration):
    ...
    q_temp = (1 - alpha) * q_temp + alpha * (stat["reward"] - stat["rho"]*stat["time"] + 0.99 * q_value_max)
    ...
    if stat["flag"] == 0:
        ...
        stat["rho"] = (1-beta)*stat["rho"] + beta * stat["total_reward"]/stat["total_time"]
...
if __name__=="__main__":
    ...
    stat, trans_pro, trans_rew, trans_time = initialize()   #initialize the parameters
    ...
    for iteration in range(IterMax):
        ...
        stat["time"] = trans_time[action, state, next_state]
    ...
    print("the rho is: ", stat["total_reward"]/stat["total_time"])
